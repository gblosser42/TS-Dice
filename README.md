Using node.js and serverQuery, this will log in to the ts.rpnation.com server and attach to the first sub-channel of Roleplay Channel that is created after it starts
